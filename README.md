...
Original source for this project is available at
[this github repository](https://github.com/classtag/codes-clean-code-functions-testable-html)

This repository uses a specific version of fitnesse library which is not included
in the mentioned repository above.  This project was converted to maven project and the
specific version of fitnesse project was added as dependency to run the project.